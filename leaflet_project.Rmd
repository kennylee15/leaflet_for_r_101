---
title: "Up and Running (Quickly) with Leaflet"
author: "Kenny Lee"
date: "3/9/2021"
...
```{r}
road_shape_ny <- readOGR(dsn = "./tl_2020_36061_roads", 
                         layer = "tl_2020_36061_roads", verbose = F)
leaflet() %>%
...
```{r}
# ACS 5-year data   
data <- read.csv("s1701.csv", stringsAsFactors = FALSE)
